...
public class ExampleMod
{
    ...
    public static final RegistryObject<EntityType<PeterEntity>> PETER =
            ENTITY_TYPES.register("peter", () -> EntityType.Builder.of(PeterEntity::new, MobCategory.CREATURE).sized(2.5f, 2.5f).build("peter"));
    */
